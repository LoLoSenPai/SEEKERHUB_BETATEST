      ...
      <div className="relative mx-auto flex max-w-5xl flex-col gap-8">
        ...
        <div className="grid items-center gap-10 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="space-y-5">
            <div className="section-eyebrow">Start building</div>
            <h1 className="text-5xl font-semibold tracking-tight text-foreground">
              Create the builder account that owns projects, releases, and private beta access.
            </h1>
            <p className="max-w-xl text-lg leading-8 text-muted-foreground">
              This builder account stays separate from tester invite sessions so you can keep release administration clean while
              still supporting lightweight tester onboarding.
            </p>
          </div>
