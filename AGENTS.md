...
This file is adapted for Codex from the original project guidance. Keep it as the repository-wide default guidance.
Before mainnet deployment, destructive operations, or irreversible migrations, ask for explicit confirmation.
